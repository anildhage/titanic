...
3. Grab the Http or SSH link of the forked repository then proceed to clone it on you computer
4. Open terminal on your Mac or any CLI that you use, choose the path where you want this program to be saved and run  ``` git clone 'paste the Https link' ```
